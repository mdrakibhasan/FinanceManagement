...
{
    public class GetAccountHeadOnlyChiled : IRequest<IEnumerable<VmAccountsHead>>;

    public class GetAccountsHeadOnlyChiledHandler : IRequestHandler<GetAccountHeadOnlyChiled, IEnumerable<VmAccountsHead>>
    {

        private readonly IAccountsHeadRepository _sateRepository;

        private readonly IMapper _mapper;
        public GetAccountsHeadOnlyChiledHandler(IAccountsHeadRepository sateRepository, IMapper mapper)
        {
        ...
        [UsedImplicitly]
        public async Task<IEnumerable<VmAccountsHead>> Handle(GetAccountHeadOnlyChiled request, CancellationToken cancellationToken)
        {

            var data = await _sateRepository.GetAccountsTypeOnlyChield();
