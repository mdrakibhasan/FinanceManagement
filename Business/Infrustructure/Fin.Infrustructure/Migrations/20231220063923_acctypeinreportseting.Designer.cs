...
namespace Pos.Infrustructure.Migrations
{
    ...
    [Migration("20231220063923_acctypeinreportseting")]
    partial class acctypeinreportseting
    {
            ...
            modelBuilder.Entity("Pos.Model.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 12, 20, 12, 39, 22, 709, DateTimeKind.Unspecified).AddTicks(5168), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Name = "Apple",
                            Status = 1
                        },
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 12, 20, 12, 39, 22, 711, DateTimeKind.Unspecified).AddTicks(9740), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Pos.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BarCode = "0001",
                            Created = new DateTimeOffset(new DateTime(2023, 12, 20, 12, 39, 22, 729, DateTimeKind.Unspecified).AddTicks(2175), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            ItemId = 1,
                            ProductName = "Apple",
                            Status = 1
                        ...
                        new
                        {
                            Id = 2,
                            BarCode = "0002",
                            Created = new DateTimeOffset(new DateTime(2023, 12, 20, 12, 39, 22, 729, DateTimeKind.Unspecified).AddTicks(2965), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            ItemId = 2,
                            ProductName = "Mango",
                            Status = 1
