...
namespace Pos.Infrustructure.Migrations
{
    ...
    [Migration("20231219094706_accountsheadcodeunique")]
    partial class accountsheadcodeunique
    {
            ...
            modelBuilder.Entity("Pos.Model.Item", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1,
                            Created = new DateTimeOffset(new DateTime(2023, 12, 19, 15, 47, 5, 546, DateTimeKind.Unspecified).AddTicks(2616), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Name = "Apple",
                            Status = 1
                        },
                        ...
                        {
                            Id = 2,
                            Created = new DateTimeOffset(new DateTime(2023, 12, 19, 15, 47, 5, 548, DateTimeKind.Unspecified).AddTicks(2212), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            Status = 1
                        });
                });
            ...
            modelBuilder.Entity("Pos.Model.Product", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = 1,
                            BarCode = "0001",
                            Created = new DateTimeOffset(new DateTime(2023, 12, 19, 15, 47, 5, 564, DateTimeKind.Unspecified).AddTicks(8018), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            ItemId = 1,
                            ProductName = "Apple",
                            Status = 1
                        ...
                        new
                        {
                            Id = 2,
                            BarCode = "0002",
                            Created = new DateTimeOffset(new DateTime(2023, 12, 19, 15, 47, 5, 564, DateTimeKind.Unspecified).AddTicks(8854), new TimeSpan(0, 6, 0, 0, 0)),
                            CreatedBy = "1",
                            ItemId = 2,
                            ProductName = "Mango",
                            Status = 1
